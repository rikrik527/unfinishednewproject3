...
public class ItemCodeDescriptionDrawer : PropertyDrawer
{
    ...
    private string GetItemDescription(int itemCode)
    {
        ...
        so_itemList = AssetDatabase.LoadAssetAtPath("Assets/Sciptable Object Assets/Item/so_ItemList.asset", typeof(SO_ItemList)) as SO_ItemList;

        List<ItemDetails> itemDetailsList = so_itemList.itemDetails;

        ItemDetails itemDetails = itemDetailsList.Find(a => a.itemCode == itemCode);
        if (itemDetails != null)
        {
